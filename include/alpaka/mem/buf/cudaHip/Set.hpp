            ...
            namespace traits
            {
                    ...
                    dev::DevCudaHipRt>
                {
                    ...
                    ALPAKA_FN_HOST static auto createTaskSet(
                        ...
                        std::uint8_t const & byte,
                        TExtent const & extent)
                    -> mem::view::cudaHip::detail::TaskSetCudaHip<
                        TDim,
                        TView,
                        TExtent>
                    {
    ...
    namespace queue
    {
        namespace traits
        {
            ...
            struct Enqueue<
                ...
                mem::view::cudaHip::detail::TaskSetCudaHip<dim::DimInt<1u>, TView, TExtent>>
            {
                //-----------------------------------------------------------------------------
                ALPAKA_FN_HOST static auto enqueue(
                    queue::QueueCudaHipRtNonBlocking & queue,
                    mem::view::cudaHip::detail::TaskSetCudaHip<dim::DimInt<1u>, TView, TExtent> const & task)
                -> void
                {
            ...
            struct Enqueue<
                queue::QueueCudaHipRtNonBlocking,
                mem::view::cudaHip::detail::TaskSetCudaHip<dim::DimInt<2u>, TView, TExtent>>
            {
                //-----------------------------------------------------------------------------
                ALPAKA_FN_HOST static auto enqueue(
                    queue::QueueCudaHipRtNonBlocking & queue,
                    mem::view::cudaHip::detail::TaskSetCudaHip<dim::DimInt<2u>, TView, TExtent> const & task)
                -> void
                {
                    ALPAKA_DEBUG_MINIMAL_LOG_SCOPE;
            ...
            struct Enqueue<
                queue::QueueCudaHipRtNonBlocking,
                mem::view::cudaHip::detail::TaskSetCudaHip<dim::DimInt<3u>, TView, TExtent>>
            {
                //-----------------------------------------------------------------------------
                ALPAKA_FN_HOST static auto enqueue(
                    queue::QueueCudaHipRtNonBlocking & queue,
                    mem::view::cudaHip::detail::TaskSetCudaHip<dim::DimInt<3u>, TView, TExtent> const & task)
                -> void
                {
                    ALPAKA_DEBUG_MINIMAL_LOG_SCOPE;
                    ...
                    cudaHipPitchedPtr const cudaHipPitchedPtrVal(
                    ...
                    cudaHipExtent const cudaHipExtentVal(
                        make_cudaHipExtent(
                    ...
                    // Initiate the memory set.
                    ALPAKA_CUDA_RT_CHECK(
                        cudaHipMemset3DAsync(
                            cudaHipPitchedPtrVal,
                            static_cast<int>(byte),
                            cudaHipExtentVal,
                            queue.m_spQueueImpl->m_CudaHipQueue));
                }
