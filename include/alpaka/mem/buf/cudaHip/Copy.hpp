            ...
            namespace cudaHip
            {
                namespace detail
                {
                        ...
                        TExtent>
                    {
                        ...
                        //-----------------------------------------------------------------------------
                        ALPAKA_FN_HOST TaskCopyCudaHip(
                            TViewDst & viewDst,
            ...
            namespace traits
            {
                    ...
                    dev::DevCudaHipRt>
                {
                    ...
                    ALPAKA_FN_HOST static auto createTaskCopy(
                        ...
                        TViewSrc const & viewSrc,
                        TExtent const & extent)
                    -> mem::view::cudaHip::detail::TaskCopyCudaHip<
                        TDim,
                        TViewDst,
                        TViewSrc,
                        TExtent>
            ...
            namespace cudaHip
            {
                namespace detail
                {
                    ...
                    ALPAKA_FN_HOST auto buildcudaMemcpy3DParms(
                        mem::view::cudaHip::detail::TaskCopyCudaHip<dim::DimInt<3>, TViewDst, TViewSrc, TExtent> const & task)
                    -> cudaMemcpy3DParms
                    {
                        ALPAKA_DEBUG_FULL_LOG_SCOPE;
                        ...
                        cudaMemCpy3DParms.srcPos = make_cudaHipPos(0, 0, 0);  // Optional. Offset in bytes.
                        cudaMemCpy3DParms.srcPtr =
                            make_cudaHipPitchedPtr(
                        ...
                        cudaMemCpy3DParms.dstPos = make_cudaHipPos(0, 0, 0);  // Optional. Offset in bytes.
                    ...
                    ALPAKA_FN_HOST auto buildcudaMemcpy3DPeerParms(
                        mem::view::cudaHip::detail::TaskCopyCudaHip<dim::DimInt<2>, TViewDst, TViewSrc, TExtent> const & task)
                    -> cudaMemcpy3DPeerParms
                    {
                        ...
                        cudaMemCpy3DPeerParms.dstPos = make_cudaHipPos(0, 0, 0);  // Optional. Offset in bytes.
                        ...
                        cudaMemCpy3DPeerParms.srcPos = make_cudaHipPos(0, 0, 0);  // Optional. Offset in bytes.
    ...
    namespace queue
    {
        namespace traits
        {
            ...
            struct Enqueue<
                ...
                mem::view::cudaHip::detail::TaskCopyCudaHip<dim::DimInt<1u>, TViewDst, TViewSrc, TExtent>>
            {
                //-----------------------------------------------------------------------------
                ALPAKA_FN_HOST static auto enqueue(
                    queue::QueueCudaHipRtNonBlocking & queue,
                    mem::view::cudaHip::detail::TaskCopyCudaHip<dim::DimInt<1u>, TViewDst, TViewSrc, TExtent> const & task)
                -> void
                {
                    ALPAKA_DEBUG_FULL_LOG_SCOPE;
                    ...
                    {
                        alpaka::mem::view::cudaHip::detail::enablePeerAccessIfPossible(iSrcDev, iDstDev);
            ...
            struct Enqueue<
                queue::QueueCudaHipRtNonBlocking,
                mem::view::cudaHip::detail::TaskCopyCudaHip<dim::DimInt<2u>, TViewDst, TViewSrc, TExtent>>
            {
                //-----------------------------------------------------------------------------
                ALPAKA_FN_HOST static auto enqueue(
                    queue::QueueCudaHipRtNonBlocking & queue,
                    mem::view::cudaHip::detail::TaskCopyCudaHip<dim::DimInt<2u>, TViewDst, TViewSrc, TExtent> const & task)
                -> void
                {
                    ALPAKA_DEBUG_FULL_LOG_SCOPE;
                    ...
                    else
                    {
                        ...
                        cudaMemcpy3DPeerParms const cudaMemCpy3DPeerParms(
                            mem::view::cudaHip::detail::buildcudaMemcpy3DPeerParms(
                                task));
                        // Initiate the memory copy.
                        ALPAKA_CUDA_RT_CHECK(
            ...
            struct Enqueue<
                queue::QueueCudaHipRtNonBlocking,
                mem::view::cudaHip::detail::TaskCopyCudaHip<dim::DimInt<3u>, TViewDst, TViewSrc, TExtent>>
            {
                //-----------------------------------------------------------------------------
                ALPAKA_FN_HOST static auto enqueue(
                    queue::QueueCudaHipRtNonBlocking & queue,
                    mem::view::cudaHip::detail::TaskCopyCudaHip<dim::DimInt<3u>, TViewDst, TViewSrc, TExtent> const & task)
                -> void
                {
                    ALPAKA_DEBUG_FULL_LOG_SCOPE;
                    ...
                    if(iDstDev == iSrcDev)
                    {
                        ...
                        cudaMemcpy3DParms const cudaMemCpy3DParms(
                            mem::view::cudaHip::detail::buildcudaMemcpy3DParms(
                                task));
                        // Set the current device.
                        ALPAKA_CUDA_RT_CHECK(
                            cudaSetDevice(
