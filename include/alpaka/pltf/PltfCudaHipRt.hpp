...
namespace alpaka
{
    namespace pltf
    {
        ...
        public:
            //-----------------------------------------------------------------------------
            ALPAKA_FN_HOST PltfCudaHipRt() = delete;
        };
    }
        ...
        namespace traits
        {
                ...
                pltf::PltfCudaHipRt>
            {
                ...
                -> dev::DevCudaHipRt
                {
                    ...
                    std::size_t const devCount(pltf::getDevCount<pltf::PltfCudaHipRt>());
                    if(devIdx >= devCount)
                    {
            ...
            private:
                ...
                ALPAKA_FN_HOST static auto printDeviceProperties(
                    cudaHipDeviceProp const & devProp)
                -> void
                {
                    ALPAKA_DEBUG_FULL_LOG_SCOPE;
